...
public class GalleryWindow : IPanel
{
    ...
    public GalleryWindow(GraphicsDevice graphicsDevice, ArtworkGallery gallery, DrawingCanvas canvas, BitmapFont font)
    {
    ...
    public void Update(GameTime gameTime)
    {
        ...
        foreach (var artwork in gallery.Saves)
        {
            ...
            {
                canvas.LoadPixelData(artwork.Width, artwork.Height, artwork.PixelData);
            }
    ...
    public void Draw(SpriteBatch spriteBatch, GameTime gameTime)
    {
        ...
        {
            spriteBatch.DrawString(font, "It's empty in here...",
        ...
        foreach (var artwork in gallery.Saves)
        {
            ...
            spriteBatch.FillRectangle(loadButtonRect, ButtonUtil.GetColor(loadButtonRect, Color.CornflowerBlue));
            ...
            spriteBatch.FillRectangle(deleteButtonRect, ButtonUtil.GetColor(deleteButtonRect, Color.IndianRed));
