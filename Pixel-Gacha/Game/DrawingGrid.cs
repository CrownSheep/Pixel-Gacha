...
public class DrawingGrid : IUpdatable, IDrawable
{
    ...
    public DrawingGrid(GraphicsDevice graphicsDevice, PlayerInventory inventory)
    {
    ...
    public void Update(GameTime gameTime)
    {
        ...
        int gridX = (int)MathF.Floor((float)(mouse.X - bounds.X) / SCALE);
        int gridY = (int)MathF.Floor((float)(mouse.Y - bounds.Y) / SCALE);
    ...
    public void SetPixel(int x, int y, Color color)
    {
        ...
        {
            inventory.RegisterPixelPainted(new Point(x, y));
        }
    }
